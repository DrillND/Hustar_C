...
{
   setMotorSpeed(motorLeft, motorSpeed-10);
...
void move_right(int motorSpeed)
{
   ...
   setMotorSpeed(motorRight, motorSpeed-10);
}
...
task main()
{
   ...
   while(TRUE)
   {
      ...
      if(getButtonPress(TRUE))
      {
         ...
         displayBigTextLine(1, "black value: %d", blackValue);
         sleep(MSEC_0_50);
         break;
      }
   }
   ...
   while(TRUE)
   {
      ...
      if(getButtonPress(TRUE))
      {
         ...
         displayBigTextLine(1, "white value: %d", whiteValue);
         sleep(MSEC_0_50);
         break;
      }
   }
